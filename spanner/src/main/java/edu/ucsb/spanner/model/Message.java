...
public class Message implements Serializable {
	...
	public enum MessageType {
		...
		PAXOS_PREPARE_FOR_COMMIT_PREPARE,
		PAXOS_PROMISE_FOR_COMMIT_PREPARE,
		PAXOS__ACCEPT_REQUEST_FOR_COMMIT_PREPARE,
		PAXOS__ACCEPT_REQUEST_ACCEPTED_FOR_COMMIT_PREPARE,
		PAXOS__ACCEPT_REQUEST_DENIED_FOR_COMMIT_PREPARE,
		PAXOS_PREPARE_FOR_FINAL_COMMIT,
		PAXOS_PROMISE_FOR_FINAL_COMMIT,
		PAXOS__ACCEPT_REQUEST_FOR_FINAL_COMMIT,
		PAXOS__ACCEPT_REQUEST_ACCEPTED_FOR_FINAL_COMMIT,
		PAXOS__ACCEPT_REQUEST_DENIED_FOR_FINAL_COMMIT,
		PAXOS_PREPARE_FOR_REPLICATE_LOG,
		PAXOS_PROMISE_FOR_REPLICATE_LOG,
		PAXOS__ACCEPT_REQUEST_FOR_REPLICATE_LOG,
		PAXOS__ACCEPT_REQUEST_ACCEPTED_FOR_REPLICATE_LOG,
		PAXOS__ACCEPT_REQUEST_DENIED_FOR_REPLICATE_LOG
	}
